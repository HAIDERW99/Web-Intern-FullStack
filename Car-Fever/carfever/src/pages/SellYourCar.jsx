...
const YEARS  = ['Select Year', ...Array.from({ length: 25 }, (_, i) => String(2024 - i))]
    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 flex flex-col items-center text-center animate-[fadeInUp_0.35s_ease-out]">
        ...
        <p className="text-body-sm text-on-surface-variant leading-relaxed mb-1">
          Your listing has been <strong className="text-deep-navy">successfully submitted</strong> and is now pending approval.
        </p>
        <p className="text-[12px] text-outline mb-7">
          We'll notify you by email once it goes live — usually within 2 hours.
        </p>
        {/* Checklist */}
        <div className="w-full bg-surface-container-low rounded-lg px-4 py-3 mb-7 space-y-2 text-left">
          {['Listing received', 'Photos uploaded', 'Pending moderator review', 'Email confirmation sent'].map(item => (
        ...
        <div className="flex-1 min-w-0 space-y-5">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-2 pb-4">
            <button onClick={handlePublish}
              className="w-full sm:w-auto flex items-center justify-center gap-3 px-10 py-4 rounded-lg text-white font-grotesk font-bold text-body-md hover:brightness-110 active:scale-[0.98] transition-all duration-150 shadow-lg"
